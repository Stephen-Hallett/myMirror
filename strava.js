    ...
    request({
        ...
        method:'POST'
            ...
            if (error || body == undefined){
                ...
                let url = 'https://www.strava.com/api/v3/athletes/113568035/stats?access_token=' + jsonData.access_token
                console.log(url);
                request({url, json:true}, (error, {body}) =>{
                    if (error || body == undefined){
                        ...
                        callback(undefined, {total_distance: (193700 + body.all_run_totals.distance)/1000, 
